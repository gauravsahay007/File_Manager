...
function FileItem({ file }) {
    ...
    return (
        <div
            className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-3 justify-between cursor-pointer hover:bg-gray-100 p-3 rounded-md"
        >
            <div className="flex items-center col-span-2 lg:col-span-3">
                ...
                />
                <h2
                    className="text-[15px] truncate ml-2"
